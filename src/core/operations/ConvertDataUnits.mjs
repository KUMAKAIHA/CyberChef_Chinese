...
const DATA_UNITS = [
    "比特 (b)", "半字节", "八位字节", "字节 (B)",
    "[二进制位 (2^n)]", "千比特 (Kib)", "兆比特 (Mib)", "吉比特 (Gib)", "太比特 (Tib)", "拍比特 (Pib)", "艾比特 (Eib)", "泽比特 (Zib)", "尧比特 (Yib)", "[/二进制位 (2^n)]",
    "[十进制位 (10^n)]", "十比特", "百比特", "千比特 (Kb)", "兆比特 (Mb)", "吉比特 (Gb)", "太比特 (Tb)", "拍比特 (Pb)", "艾比特 (Eb)", "泽比特 (Zb)", "尧比特 (Yb)", "[/十进制位 (10^n)]",
